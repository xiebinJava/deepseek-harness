...
export type AgentPresetSettingsKey =
  | 'error' | 'userTrust' | 'seatHint' | 'headerHint' | 'labelNewSessionWithPreset'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  labelNewSessionWithPreset: 'Click to start a new session with this agent preset',
  nav: 'Agent presets',
  sectionIntro:
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  labelNewSessionWithPreset: '点击：用这个 Agent 开一个新会话',
  nav: 'Agent 预设',
